...
let rockButton = document.querySelector("body > div.buttons > button.rock");
rockButton.setAttribute('onclick',"playRound('Rock')")

let paperButton = document.querySelector("body > div.buttons > button.paper");
paperButton.setAttribute('onclick',"playRound('Paper')")

let scissorsButton = document.querySelector("body > div.buttons > button.scissors");
